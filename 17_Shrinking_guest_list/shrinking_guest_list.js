...
console.log(`\n Apologizes ... I can invite only two person`)

for (i=guest_list.length; i>=3; i--){
    //console.log(`Sorry ${i} I can't arrange dinner today`)
    console.log(`Sorry I can't invite you respected ${guest_list[i-1]}`)
    guest_list.pop();
}
